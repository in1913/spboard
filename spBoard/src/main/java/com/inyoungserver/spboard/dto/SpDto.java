package com.inyoungserver.spboard.dto;
...
public class SpDto {
	...
	public SpDto(int num, int s_group, int s_step, int s_indent, String uname, String upass, String title,
			String content, int ct, int hit, Timestamp wdate) {
		super();
		this.num = num;
